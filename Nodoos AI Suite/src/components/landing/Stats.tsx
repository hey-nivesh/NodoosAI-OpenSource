      ...
      <div className="mx-auto max-w-7xl px-4 py-16 md:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Empowering customer success and product teams to operate at unmatched velocity.
          </p>
        </div>
        <div className="mt-12 grid grid-cols-2 gap-6 md:grid-cols-4">
          {stats.map((s) => (
            <div key={s.l} className="text-center">
              <div className="bg-gradient-to-br from-foreground to-accent bg-clip-text text-4xl font-semibold text-transparent md:text-5xl">
                {s.v}
              </div>
