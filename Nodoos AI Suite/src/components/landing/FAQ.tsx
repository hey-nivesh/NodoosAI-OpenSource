...
const qs = [
  {
    q: "How does the autonomous agent ingest Snowflake data?",
    a: "Nodoos AI connects via native Snowflake Cortex APIs using zero-copy data sharing, ensuring your sensitive enterprise telemetry never leaves your cloud perimeter.",
  },
  { q: "Can I integrate existing CRM tools?", a: "Yes, we support native two-way sync with Salesforce, Hubspot, Zendesk, and custom HTTP webhooks." },
  { q: "Is there a free trial available?", a: "We offer a 14-day full feature trial with full access to our CoCo CLI suite and pre-built playbooks." },
  {
  ...
  { q: "Can I upgrade or downgrade anytime?", a: "Yes, you can manage your subscription instantly from your dashboard settings." },
  {
    ...
    <section id="faq" className="mx-auto max-w-4xl px-4 py-20 md:px-6 md:py-28">
      <div className="text-center">
        ...
        <p className="mt-4 text-muted-foreground">
          Everything you need to know about integrating Nodoos AI into your infrastructure.
        </p>
      </div>
