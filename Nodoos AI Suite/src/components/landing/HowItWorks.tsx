...
const steps = [
  {
    ...
    desc: "Link your Snowflake telemetry, CRM, and billing systems via one-click secure OAuth.",
  },
  {
    n: "02",
    title: "Configure Agent Skills",
    desc: "Define CLI commands and automated triggers for usage drops and sentiment shifts.",
  },
  {
    n: "03",
