...
const reviews = [
  ...
  {
    quote:
      "Nodoos AI completely automated our account health scoring. The LangGraph AI integration is unmatched.",
    author: "Elena Rostova",
    role: "Lead Architect",
  },
  {
    quote:
      "It transformed how we handle customer churn signals across our entire enterprise portfolio.",
    author: "Sarah Jenkins",
    role: "Head of Customer Success",
  },
  {
    quote:
      "The predictive intelligence accuracy is insane. Setup took under 10 minutes.",
    author: "Jason Lee",
    role: "Staff Engineer",
  },
];
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-3 border-t border-border pt-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.58 0.19 262), oklch(0.22 0.04 265))",
                }}
              >
                {r.author[0]}
              </div>
