    ...
    <section className="relative flex min-h-[calc(100vh-4rem)] overflow-hidden bg-transparent">
      <div className="relative mx-auto flex w-full max-w-7xl flex-col justify-between px-4 pt-4 pb-2 md:px-6 md:pt-6 md:pb-3">
        ...
        <div className="relative mt-6">
          ...
          >
            Empower your team with advanced AI tools that automate repetitive
          ...
          <FloatIcon
            src="/icon-slack.png"
            alt="Slack"
            className="left-2 top-2 h-10 w-10 md:left-16 md:top-10 md:h-14 md:w-14"
            delay={0.3}
          />
          <FloatIcon
            src="/icon-notes.png"
            alt="Notes"
            className="left-4 top-28 h-9 w-9 md:left-24 md:top-44 md:h-12 md:w-12"
            delay={0.45}
          />
          <FloatIcon
            src="/icon-gmail.png"
            alt="Gmail"
            className="right-2 top-2 h-10 w-10 md:right-24 md:top-16 md:h-14 md:w-14"
            delay={0.35}
          />
          <FloatIcon
            src="/icon-google.png"
            alt="Google"
            className="right-6 top-28 h-10 w-10 md:right-40 md:top-44 md:h-14 md:w-14"
            delay={0.5}
          />
            ...
            <div className="mt-2 flex h-12 items-end gap-1">
              {[45, 30, 65, 40, 75, 55, 85, 60].map((h, i) => (
                <div
                  ...
                  style={{
                    height: `${h}%`,
                    background: `linear-gradient(to top, oklch(0.58 0.19 262 / 0.2), oklch(0.58 0.19 262 / 0.6))`,
                  }}
                />
              ))}
            </div>
...
function FloatIcon({
  ...
  return (
    ...
    >
      <Image src={src} alt={alt} width={56} height={56} className="object-contain w-full h-full" />
    </motion.div>
  );
}
