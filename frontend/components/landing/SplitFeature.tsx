      ...
      <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        >
          ...
          <p className="mt-3 text-muted-foreground">
            Continuously scans user behavior, telemetry logs, and support
            interactions to flag retention risks before they turn into
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="relative overflow-hidden rounded-3xl border border-border p-10 text-primary-foreground shadow-xl"
          style={{ background: "linear-gradient(135deg, oklch(0.22 0.04 265), oklch(0.22 0.04 265 / 0.8))" }}
        >
          <div
            className="absolute right-0 top-0 h-40 w-40 rounded-full blur-3xl"
            style={{ background: "oklch(0.58 0.19 262 / 0.4)" }}
          />
          <div className="relative">
            ...
            <div className="text-sm" style={{ color: "oklch(0.99 0 0 / 0.7)" }}>
              Total revenue restored this quarter
            </div>
          </div>
        </motion.div>
      </div>
